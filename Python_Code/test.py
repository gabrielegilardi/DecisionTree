...
- As basic case but changing the number of leaves.
...
- As basic case but changing the tolerance.
...
- As basic case but using bagging.
...
np.random.seed(1)
# Added to avoid warning "invalid value encountered in true_divide c /= stddev[None, :]"
# during cross-correlation computation
...
if (learner_type == 'dt'):
    ...
    # With bagging
        ...
        learner = bl.BagLearner(dtl.DTLearner, {"leaf": leaf, "tol": tol}, bags, \
            bag_factor, boost)
...
# Random tree            
    ...
    # With bagging
        ...
        learner = bl.BagLearner(rtl.RTLearner, {"leaf": leaf, "tol": tol}, bags, \
            bag_factor, boost)
...
# Compute root-mean-square-error and correlation between predicted and actual labels
